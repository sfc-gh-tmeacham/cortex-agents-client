...
def pat_auth() -> PATAuth:
    """Returns a PATAuth instance for tests."""
    return PATAuth(PAT_TOKEN)


@pytest.fixture
def http_client(pat_auth) -> HttpClient:
    """Returns an HttpClient for direct resource testing."""
    return HttpClient(ACCOUNT_URL, pat_auth, timeout=30.0)
